...
#import "Constants.h"
@implementation P2PVideoVolumeSettingCell
-(void)dealloc{
...
-(void)layoutSubviews{
    ...
    if(!self.customView){
        ...
        UISlider *slider = [[UISlider alloc] initWithFrame:CGRectMake(0, 0, customView.frame.size.width, customView.frame.size.height)];
        ...
        self.slider.frame = CGRectMake(0, 0, self.customView.frame.size.width, self.customView.frame.size.height);
        [self.contentView addSubview:self.customView];
