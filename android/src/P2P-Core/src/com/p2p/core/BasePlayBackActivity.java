...
public abstract class BasePlayBackActivity extends BaseCoreActivity{
	...
	public void pausePlayBack(){
		MediaPlayer.iRecFilePlayingControl(PAUSE,0);
	}
	
	public void startPlayBack(){
		MediaPlayer.iRecFilePlayingControl(START,0);
	}
	
	public boolean previous(){
		if(MediaPlayer.iRecFilePlayingControl(PREVIOUS,0)==0){
			return false;
		}else{
			return true;
		}
	...
	public boolean next(){
		if(MediaPlayer.iRecFilePlayingControl(NEXT,0)==0){
			return false;
		}else{
			return true;
		}
	...
	public void jump(int value){
		MediaPlayer.iRecFilePlayingControl(JUMP,value);
	}
