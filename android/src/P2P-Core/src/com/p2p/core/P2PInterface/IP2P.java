...
public interface IP2P {
	...
	public void vAllarmingWitghTime(String srcId, int type, boolean isSupportExternAlarm, int iGroup, int iItem,int imagecounts,String imagePath,String VideoPath);
}
