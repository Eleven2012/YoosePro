...
public class QuickActionBar extends QuickActionWidget {
    ...
    protected void populateQuickActions(List<QuickAction> quickActions) {
        ...
        for (QuickAction action : quickActions) {
        	LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.gd_quick_action_bar_item, mQuickActionItems, false);
        	TextView view = (TextView) layout.findViewById(R.id.item_name);
        	view.setText(action.mTitle);
            ImageView img = (ImageView) layout.findViewById(R.id.item_img);
            img.setImageDrawable(action.mDrawable);
            layout.setOnClickListener(mClickHandlerInternal);
            mQuickActionItems.addView(layout);
            action.mView = new WeakReference<View>(layout);
        }
    }
