...
public class AddBar extends RelativeLayout{
	...
	public void addItem(String id){
		...
		View view = LayoutInflater.from(mContext).inflate(R.layout.list_add_bar_item, null);
		
		
		final RelativeLayout item = (RelativeLayout) view.findViewById(R.id.add_bar_item);
		...
		if(item_count>0){
			...
			RelativeLayout last_item = (RelativeLayout) last_view.findViewById(R.id.add_bar_item);
	...
	public void removeItem(int position){
		...
		RelativeLayout item = (RelativeLayout) view.findViewById(R.id.add_bar_item);
		...
		if(item_count>0){
			RelativeLayout last_item = (RelativeLayout) items.get(item_count-1).findViewById(R.id.add_bar_item);
	...
	private void UpdateItemListener(){
		for(int i=0;i<items.size();i++){
			...
			final RelativeLayout item = (RelativeLayout) view.findViewById(R.id.add_bar_item);
			final ImageView left_icon = (ImageView) view.findViewById(R.id.delete_item);
