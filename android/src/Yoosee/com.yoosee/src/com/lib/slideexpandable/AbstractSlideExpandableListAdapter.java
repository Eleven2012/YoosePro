...
public abstract class AbstractSlideExpandableListAdapter extends WrapperListAdapterImpl {
			...
			public void onClick(final View view) {
				...
				if (a != null && a.hasStarted() && !a.hasEnded()) {
					...
					if (type == ExpandCollapseAnimation.EXPAND) {
						Log.e("my","expand");
						//arrow animation
						/*ImageView arrow = (ImageView) button.findViewById(com.handmark.pulltorefresh.library.R.id.arrow);
					...
					if (type == ExpandCollapseAnimation.EXPAND) {
						if (lastOpenPosition != -1 && lastOpenPosition != position) {
							...
							//arrow animation
							/*ImageView arrow = (ImageView) lastToggle.findViewById(com.handmark.pulltorefresh.library.R.id.arrow);
							Animation rotate = new RotateAnimation(180f,0f,Animation.RELATIVE_TO_SELF,0.5f,Animation.RELATIVE_TO_SELF,0.5f);
					        rotate.setFillAfter(true);
					        rotate.setDuration(380);
					        arrow.startAnimation(rotate);*/
	...
	public abstract View getArrowView(View parent);
}
