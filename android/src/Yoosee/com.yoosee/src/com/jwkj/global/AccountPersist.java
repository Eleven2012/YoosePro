...
public class AccountPersist {
	...
	public void setActiveAccount(Context context,Account account){
		...
		SharedPreferences preference = context.getSharedPreferences(ACCOUNT_SHARED_PREFERENCE, context.MODE_PRIVATE);
	...
	public Account getActiveAccountInfo(Context context){
		...
		if(three_number.equals("")){
			...
			return new Account(three_number,email, phone, sessionId, code1, code2 ,countryCode);
		}
	}
