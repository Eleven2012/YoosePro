...
//					it.putStringArrayListExtra("adddata", (ArrayList<String>) list);
					sendBroadcast(it);
					
//					List<String> oldlist=madapter.getList();
//					if(list.size()<=0){
//			    		return;
//			    	}
...
//			    	Log.e("oldlist", "oldlist"+oldlist);
//			    	RecordAdapter radapter=new RecordAdapter();
//			    	
//			    	radapter.setList(oldlist);
////					madapter.upLoadData(list);
//			    	radapter.loadData();
				}
