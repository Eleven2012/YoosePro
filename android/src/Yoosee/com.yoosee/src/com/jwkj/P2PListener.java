...
public class P2PListener implements IP2P{
	...
	public void vCalling(boolean isOutCall,String threeNumber,int type) {
		...
		if(isOutCall){
			...
			int c_vibrateState = SharedPreferencesManager.getInstance().getCVibrateState(MyApp.app);
			if(c_vibrateState==1){
	...
	public void vReject(int reason_code) {
		...
		case 11:
			...
			break;
		case 12:
			reason = MyApp.app.getResources().getString(R.string.internal_error);
			break;
		case 13:
	...
	public void vAllarming(String srcId, int type,
		...
		// TODO Auto-generated method stub
		P2PConnect.vAllarming(Integer.parseInt(srcId),type,isSupportExternAlarm,iGroup,iItem);
	}
	...
	@Override
	public void vAllarmingWitghTime(String srcId, int type,
			boolean isSupportExternAlarm, int iGroup, int iItem,
			int imagecounts, String imagePath, String VideoPath) {
	}
}
