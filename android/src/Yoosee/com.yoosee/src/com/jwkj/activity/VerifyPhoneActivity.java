...
public class VerifyPhoneActivity extends BaseActivity implements OnClickListener{
	...
	public void resendCode(){
		dialog = new NormalDialog(this,
				this.getResources().getString(R.string.waiting_verify_code),
				"","","");
	...
	public void checkCode(){
		...
		dialog = new NormalDialog(this,
				this.getResources().getString(R.string.verifing),
				"","","");
		dialog.setStyle(NormalDialog.DIALOG_STYLE_LOADING);
		dialog.setOnCancelListener(new OnCancelListener(){
	...
	class VerifyCodeTask extends AsyncTask{
		...
		protected Object doInBackground(Object... params) {
			// TODO Auto-generated method stub
			Utils.sleepThread(1000);
			return NetManager.getInstance(mContext).verifyPhoneCode(countryCode, phoneNO, code);
		}
		...
		protected void onPostExecute(Object object) {
			...
			case NetManager.VERIFY_CODE_ERROR:
				...
				if(!isDialogCanel){
					Utils.showPromptDialog(mContext,R.string.prompt, R.string.vfcode_error);
				}
				break;
			case NetManager.VERIFY_CODE_TIME_OUT:
				...
				if(!isDialogCanel){
					Utils.showPromptDialog(mContext,R.string.prompt, R.string.vfcode_timeout);
				}
				break;
			default:
				if(dialog!=null){
	...
	class GetPhoneCodeTask extends AsyncTask{
		...
		protected Object doInBackground(Object... params) {
			// TODO Auto-generated method stub
			Utils.sleepThread(1000);
			return NetManager.getInstance(mContext).getPhoneCode(CountryCode, PhoneNO);
		}
		...
		protected void onPostExecute(Object object) {
			...
			case NetManager.GET_PHONE_CODE_PHONE_USED:
				...
				if(!isDialogCanel){
					Utils.showPromptDialog(mContext,R.string.prompt, R.string.phone_number_used);
				}
				break;
			default:
				if(dialog!=null){
