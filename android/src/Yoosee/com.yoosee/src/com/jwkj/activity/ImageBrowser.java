...
//		String screenshotPath = Environment.getExternalStorageDirectory().getPath()+"/screenshot";
...
//						switcher.setInAnimation(AnimationUtils.loadAnimation(context, R.anim.slide_in_right_100));
//						switcher.setOutAnimation(AnimationUtils.loadAnimation(context, R.anim.slide_out_left_100));
//						
...
//					if(--selectedItem>=0){
//						switcher.setInAnimation(AnimationUtils.loadAnimation(context, R.anim.slide_in_left_100));
//						switcher.setOutAnimation(AnimationUtils.loadAnimation(context, R.anim.slide_out_right_100));
//						String path = ((File)files[selectedItem]).getPath();
//						mTempBitmap = BitmapFactory.decodeFile(path);
//						switcher.setImageDrawable(new BitmapDrawable(mTempBitmap));
//					}else{
