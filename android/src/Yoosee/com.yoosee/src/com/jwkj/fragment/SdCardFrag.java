...
public class SdCardFrag extends Fragment implements OnClickListener {
    ...
    public void initComponent(View view){
    	...
    	tv_sd_remainning_capacity=(TextView)view.findViewById(R.id.tv_sd_remainning_capacity);
    	...
    	usb_remainning_capacity=(RelativeLayout)view.findViewById(R.id.usb_remainning_capacity);
	...
	public void onClick(View v) {
		...
		case R.id.sd_format:
			final NormalDialog dialog=new NormalDialog(mContext,
					mContext.getResources().getString(R.string.sd_formatting),
					mContext.getResources().getString(R.string.delete_sd_remind),
