...
import com.jwkj.global.Constants.P2P_SET.INIT_PASSWORD_SET;
...
public class RecordListFragment extends Fragment implements OnScrollListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mContext = PlayBackListActivity.mContext;
...
//		list_record.addFooterView(view1);
		...
		list_record.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				P2PHandler.getInstance().playbackConnect(contact.contactId, contact.contactPassword,filename, arg2);
		...
		// TODO Auto-generated method stub
		  ...
		  if(itemsLastIndex==visibleLastIndex){
			  ...
			  try {
				...
				P2PHandler.getInstance().getRecordFiles(contact.contactId, contact.contactPassword, nextStartTime, nextEndTime);
