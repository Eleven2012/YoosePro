...
public class BellChoiceAdapter extends BaseAdapter{
	...
	public View getView(int arg0, View view, ViewGroup arg2) {
		...
		if(null==item){
			item = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.choice_bell_list_item, null);
			item.setTag(item);
		}else{
		...
		final RadioButton button = (RadioButton) item.findViewById(R.id.checkButton);
