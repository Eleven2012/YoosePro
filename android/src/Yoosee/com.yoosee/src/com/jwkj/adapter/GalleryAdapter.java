...
public class GalleryAdapter extends BaseAdapter{
	...
	public View getView(int position, View arg1, ViewGroup arg2) {
		...
		if(selectedItemId==position){  
			...
			Bitmap frame = BitmapFactory.decodeResource(context.getResources(), R.drawable.frame);
			
			img.setImageBitmap(Utils.montageBitmap(frame,bitmap,200,200));
			
			int selectedWidth = (int) (screenWidth/5*1.4);
			RelativeLayout.LayoutParams selectedParams = (LayoutParams) img.getLayoutParams();
