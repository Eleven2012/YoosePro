...
public class ModifyAccountPhoneActivity extends BaseActivity implements OnClickListener{
	...
	public void initCompent() {
		...
		String countryName = SearchListActivity.getNameByCode(mContext, Integer.parseInt(countryCode));
			...
			case NetManager.GET_PHONE_CODE_SUCCESS:
				...
				if(!isDialogCanel){
					if(CountryCode.equals("86")){
						Intent i = new Intent(mContext,ModifyAccountPhoneActivity2.class);
	...
	public void showInputPwd(final String phone,final String countryCode){
		...
		dialog_input.setTitle(mContext.getResources().getString(R.string.change_phone));
