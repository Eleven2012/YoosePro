...
public class ElianNative {
	...
	/*
	 * 开始智能连机（WiFi的SSID,WiFi的密码，"",WiFi的加密方式） 枚举值如下
	 * byte AuthModeAutoSwitch =2;
	 * byte AuthModeOpen = 0; 
	 * byte AuthModeShared = 1;
	 * byte AuthModeWPA = 3;
	 * byte AuthModeWPA1PSKWPA2PSK = 9;
	 * byte AuthModeWPA1WPA2 = 8; 
	 * byte AuthModeWPA2 = 6; 
	 * byte AuthModeWPA2PSK = 7; 
	 * byte AuthModeWPANone = 5; 
