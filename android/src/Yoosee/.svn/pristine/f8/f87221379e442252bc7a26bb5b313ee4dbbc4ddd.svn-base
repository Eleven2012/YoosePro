...
public class SharedPreferencesManager {
	...
	public void putIsDoorbellBind(String doorbellId,boolean isDoorBellBind,Context context){
		SharedPreferences sf = context.getSharedPreferences(SP_FILE_GWELL, context.MODE_PRIVATE);
		Editor editor = sf.edit();
	...
	public void putIsDoorBellToast(String doorbellId,boolean isDoorBellBind,Context context){
		SharedPreferences sf = context.getSharedPreferences(SP_FILE_GWELL, context.MODE_PRIVATE);
		Editor editor = sf.edit();
		editor.putBoolean(doorbellId, isDoorBellBind);
		editor.commit();
