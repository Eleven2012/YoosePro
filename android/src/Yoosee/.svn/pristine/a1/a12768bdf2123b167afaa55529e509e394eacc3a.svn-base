...
public class SysMsgActivity extends BaseActivity implements OnClickListener{
	...
	public void initComponent(){
		list = (ActionSlideExpandableListView)this.findViewById(R.id.list_sys_msg);
		back = (ImageView) findViewById(R.id.back_btn);
		
		back.setOnClickListener(this);
		List<SysMessage> data = DataManager.findSysMessageByActiveUser(mContext, NpcCommon.mThreeNum);
